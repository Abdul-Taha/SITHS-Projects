...
def store_color():
    ...
    #Create widgets for the stored colors
    ...
    #Put the widgets onto the screen
    ...
    #Update the dictionary of stored colors with new color tuple and hex values
    stored_colors[stored_color.get()] = [new_color_tuple.cget("text"), new_color_hex.cget("text")]


    #Move the radio buttons stored colors to the value if available
